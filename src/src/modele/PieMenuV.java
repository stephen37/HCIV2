...
public class PieMenuV extends CanvasItem{

	Point firstpoint;
	String pathImage = "PieMenu/Pie/Pie4VTrans.png";
	
	public PieMenuV(PersistentCanvas c, Color o, Color f, Point p, int v) throws IOException{
			super(c, o, f, v);
