...
public class PieMenuH extends CanvasItem{

	Point firstpoint;
	String pathImage = "PieMenu/Pie/Pie4HTrans.png";
	
	public PieMenuH(PersistentCanvas c, Color o, Color f, Point p, int v) throws IOException{
			super(c, o, f, v);
